...
RSpec.describe Admin::GenresController, type: :controller do
  ...
  let!(:genre_1){FactoryBot.create :genre, name: "Action"}
  let!(:genre_2){FactoryBot.create :genre, name: "Horror"}
  let!(:genre_3){FactoryBot.create :genre, name: "Adventure"}
  let!(:genre_4){FactoryBot.create :genre, name: "Comedy"}
